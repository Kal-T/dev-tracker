    ...
    <div class="bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
      ...
      >
        <div>
          <router-link
            to="/board"
            class="text-blue-600 hover:text-blue-800 text-sm font-bold flex items-center gap-1 mb-2 transition-colors"
          >
            &larr; Back to Board
          </router-link>
          <h1 v-if="!isEditing" class="text-3xl font-black text-slate-900 tracking-tight">
            {{ task.title }}
          </h1>
          <input
            v-else
